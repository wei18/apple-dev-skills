...
| `## Deviation considerations` | *when to override* the default, and the cost (e.g. "Drop to iOS 17 when targeting education devices — you lose full Observation behaviour"). Also ours. | Not retrofitted | 22/38 |
